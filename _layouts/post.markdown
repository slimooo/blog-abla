  ...
  <article class="post">
    ...
    <div class="post__share">
      <ul class="share__list list-reset">
        ...
        <li class="share__item">
          <a class="teams-share-button" href="https://teams.microsoft.com/share/?url={{ site.url }}{{ page.url }}&amp;media={{ site.url }}{{ site.baseurl }}{{ page.image }}&amp;description={{ page.title | uri_escape }}"
